    ...
    <section className="py-14 container mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-5 gap-12">
        <div className="flex flex-col">
          <h2 className="text-white font-semibold text-lg">Quais empresas podem se beneficiar do ESH?</h2>
          <p className="text-neutral-500 font-normal">Nossas soluções de segurança se encaixam em diversas indústrias, incluindo ISP's, telecoms, financeiras e manufaturas.</p>
        </div>
        <div className="flex flex-col">
          <h2 className="text-white font-semibold text-lg">Quais empresas podem se beneficiar do ESH?</h2>
          <p className="text-neutral-500 font-normal">Nossas soluções de segurança se encaixam em diversas indústrias, incluindo ISP's, telecoms, financeiras e manufaturas.</p>
