export function Audition() {
  return (
    <section className="py-24 md:container mx-auto px-5 md:px-0">
      <div className="py-1 px-10 rounded-full bg-neutral-800 text-neutral-400  w-max mx-auto">Auditoria</div>
      <h1 className="text-white text-xl md:text-3xl font-semibold my-10 text-center">Auditoria sem brechas, em tempo real e sob demanda</h1>
