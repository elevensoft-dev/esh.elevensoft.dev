  ...
  return (
    <div
      className={`relative flex flex-col p-8 rounded-xl border ${
        isFeatured ? 'border-orange-500 border-2' : 'border-neutral-800'
      }`}
    >
      {isFeatured && (
        ...
        {features.map((feature, index) => (
          <li
            ...
            className={`flex gap-3 items-start ${
              feature.isHighlight ? 'font-bold text-orange-300' : ''
            }`}
          >
            <CheckIcon
      ...
      <a
        ...
        className={`mt-8 block w-full text-center rounded-lg py-3 font-semibold transition-colors ${
          isFeatured
  ...
  if (feature) {
    return (
      <tr>
        ...
        <td className="w-40 py-4 px-4 text-center">
          {start ? <CheckIcon className="h-5 w-5 text-green-500 mx-auto" /> : <Cross1Icon className="h-5 w-5 text-red-500 mx-auto" />}
        </td>
        <td className="w-40 py-4 px-4 text-center border-2 border-orange-500">
          {pro ? <CheckIcon className="h-5 w-5 text-green-500 mx-auto" /> : <Cross1Icon className="h-5 w-5 text-red-500 mx-auto" />}
        </td>
        <td className="w-40 py-4 px-4 text-center">
          {enterprise ? <CheckIcon className="h-5 w-5 text-green-500 mx-auto" /> : <Cross1Icon className="h-5 w-5 text-red-500 mx-auto" />}
        </td>
      </tr>
    );
  }
